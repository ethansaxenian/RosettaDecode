...
from split_data import parse_features_data, split_train_vali_test
...
def test_model(model: ClassifierMixin, X_test: np.ndarray, y_test: np.ndarray) -> float:
    count = 0
    correct = 0
...
if __name__ == '__main__':
    ...
    print(test_model(logit.model, X_test, y_test))
